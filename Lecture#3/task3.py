...
print("This is a mini program for calculating scores for the game Scrabble")
def fun(x):
    for key in alph_scrabble:
        if x in key:
            return alph_scrabble.get(key)
...
print(sum(map(fun, input("Now please Enter letters: "))))
